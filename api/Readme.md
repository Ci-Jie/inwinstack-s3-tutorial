...
```
sudo apt-get update
sudo apt-get -y install apache2 mysql-server php5-mysql php5 libapache2-mod-php5 php5-mcrypt php5-curl php5-gd php5-intl php5-xsl php5-ldap libssh2-php
```
